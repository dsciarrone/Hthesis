...
Original file is located at
    https://colab.research.google.com/drive/1BFabnaHLMl7JcNK1UkmjQOrqlZzvWjKp

# Trainable Classifier Neural Networks for Blood Vessel Segmentation of OCT
...
class classifier():
    ...
    def alexnet(self):
      global model_type
      model_type = 'alexnet'
      model = torchvision.models.alexnet(progress=True)
...
class loop():
    ...
    def train(self):        
        ...
        for batch in tqdm(iter(self.data_loader)):
